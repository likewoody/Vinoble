    ...
    var body: some Reducer<State, Action>{
        ...
        Reduce { state, action in
            ...
            case .fetchRecommend:
                ...
                return .run { send in
                    let recommendations = await tryHttpSessionRecommend(httpURL: "http://127.0.0.1:5000/recommend?searchRecommend=\(searchRecommend)")
            ...
            case .fetchKeywords:
                return .run { send in
                    ...
                    let keywords = await tryHttpSessionKeyword(httpURL: "http://127.0.0.1:5000/topKeyowrds")
